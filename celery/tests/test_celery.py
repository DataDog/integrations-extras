...
def test__check_task_metrics(check, aggregator, worker_instance):
    ...
    inspect.active.return_value = {
        'celery@173b8997ac64': [
            {
                'id': '6c4dd7eb-c18c-41dd-a1d0-e77e4458f602',
                'name': 'tasks.add',
                'args': [1, 2],
                'kwargs': {},
                'type': 'tasks.add',
                'hostname': 'celery@173b8997ac64',
                'time_start': 1682450302.0659862,
                'acknowledged': True,
...
def test__check_worker_metrics(check, aggregator, worker_instance):
    ...
    inspect.stats.return_value = {
        'celery@173b8997ac64': {
            ...
            'pool': {
                'max-concurrency': 8,
                'processes': [7, 8, 9, 10, 11, 12, 13, 14],

...
from datadog_checks.gatekeeper.config_models import ConfigMixin, InstanceConfig, SharedConfig, defaults
...
def test_config_models_smoke_test():
    ...
    data = {
        "gatekeeper_health_endpoint": "http://localhost:9090",
        "prometheus_url": "http://localhost:9090/metrics",
        "auth_token": {"reader": {"path": "/reader"}, "writer": {"path": "/writer"}},
        "kerberos_auth": "required",
        "ignore_metrics_by_labels": {"label": ("value",)},

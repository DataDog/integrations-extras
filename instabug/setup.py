...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'instabug', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-instabug',
    version=ABOUT['__version__'],
    description='The Instabug check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent instabug check',
    # The project's main homepage.
    url='https://github.com/DataDog/integrations-extras',
    # Author details
    author='Hemdan',
    author_email='ahemdan@instabug.com',
    # License
    ...
    packages=['datadog_checks.instabug'],

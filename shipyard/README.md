...
3. Under the Datadog section, enter your Datadog API key and the Datadog site URL. *Note: The site URL is not required and therefore we suggest you try your connection with just your token to begin with*
   ![datadog-input][6]

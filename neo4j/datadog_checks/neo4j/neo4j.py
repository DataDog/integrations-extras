...
class Neo4jCheck(PrometheusCheck):
    ...
    def get_whitelisted_metrics():
        return {
            ...
            'dbms_pool_page_cache_total_size': 'dbms.pool.page_cache.total_size',
            'dbms_pool_page_cache_free': 'dbms.pool.page_cache.free',
            'dbms_pool_page_cache_total_used': 'dbms.pool.page_cache.total_used',
            'dbms_pool_page_cache_used_native': 'dbms.pool.page_cache.used_native',
            'dbms_pool_page_cache_used_heap': 'dbms.pool.page_cache.used_heap',
            #
            'dbms_pool_other_total_size': 'dbms.pool.other.total_size',
            'dbms_pool_other_free': 'dbms.pool.other.free',
            'dbms_pool_other_total_used': 'dbms.pool.other.total_used',
            'dbms_pool_other_used_native': 'dbms.pool.other.used_native',
            'dbms_pool_other_used_heap': 'dbms.pool.other.used_heap',
            #
            'dbms_pool_recent_query_buffer_total_size': 'dbms.pool.recent_query_buffer.total_size',
            'dbms_pool_recent_query_buffer_free': 'dbms.pool.recent_query_buffer.free',
            'dbms_pool_recent_query_buffer_total_used': 'dbms.pool.recent_query_buffer.total_used',
            'dbms_pool_recent_query_buffer_used_native': 'dbms.pool.recent_query_buffer.used_native',
            'dbms_pool_recent_query_buffer_used_heap': 'dbms.pool.recent_query_buffer.used_heap',
            #
            'dbms_pool_transaction_total_size': 'dbms.pool.transaction.total_size',
            'dbms_pool_transaction_free': 'dbms.pool.transaction.free',
            'dbms_pool_transaction_total_used': 'dbms.pool.transaction.total_used',
            'dbms_pool_transaction_used_native': 'dbms.pool.transaction.used_native',
            'dbms_pool_transaction_used_heap': 'dbms.pool.transaction.used_heap',
            #
            'dbms_pool_bolt_total_size': 'dbms.pool.bolt.total_size',
            'dbms_pool_bolt_free': 'dbms.pool.bolt.free',
            'dbms_pool_bolt_total_used': 'dbms.pool.bolt.total_used',
            'dbms_pool_bolt_used_native': 'dbms.pool.bolt.used_native',
            'dbms_pool_bolt_used_heap': 'dbms.pool.bolt.used_heap',
            #
            # JVM threads metrics

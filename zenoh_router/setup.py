...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'zenoh_router', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-zenoh_router',
    version=ABOUT['__version__'],
    description='The Zenoh Router check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent zenoh router check',
    ...
    packages=['datadog_checks.zenoh_router'],

...
class MariadbSkysqlCheck(OpenMetricsBaseCheckV2):
    ...
    OPEN_METRICS_ENDPOINT = "https://api.mariadb.net/observability/v2/metrics"
    ...
    def get_default_config(self):
        default_config = {'openmetrics_endpoint': self.OPEN_METRICS_ENDPOINT, 'metrics': [MARIADB_SKYSQL_METRICS]}

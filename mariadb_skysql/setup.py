...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'mariadb_skysql', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-mariadb_skysql',
    version=ABOUT['__version__'],
    description='The MariaDB SkySQL check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent mariadb_skysql check',
    # The project's main homepage.
    url='https://github.com/DataDog/integrations-extras',
    # Author details
    author='bb',
    author_email='support@mariadb.com',
    # License
    ...
    packages=['datadog_checks.mariadb_skysql'],

...
px_cluster_cpu_percent{cluster="clusterpaul",node="devbox",node_id="f6c68c67-7c4f-4b3b-ab50-f5a046be5c3d"} 0.76
...
def test_check_all_metrics(aggregator):
    ...
    response = mock.MagicMock(status_code=200, headers={"Content-Type": "text/plain"}, iter_lines=lambda **kw: data.split("\n"))

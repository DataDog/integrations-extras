...
class PortworxCheck(PrometheusCheck):
    ...
    def __init__(self, name, init_config, instances=None):
        ...
        self.metrics_mapper = {
            ...
            'px_alerts_poolexpandfailed': 'alerts.pool_expand_failed',
            ...
            'px_disk_stats_num_reads': 'disk_stats.num_reads',
            'px_disk_stats_num_writes': 'disk_stats.num_writes',
            'px_network_io_bytessent': 'network_io.bytessent',
            'px_network_io_received_bytes': 'network_io.received_bytes',
            'px_node_status_node_status': 'node_status.status',
            'px_node_status_license_expiry': 'node_status.licence_expiry',
            ...
            'px_pool_stats_available_bytes': 'pool_stats.available_bytes',
            'px_pool_stats_used_bytes': 'pool_stats.used_bytes',
            'px_pool_stats_total_bytes': 'pool_stats.total_bytes',
            'px_pool_stats_status': 'pool_stats.status',
            'px_pool_stats_write_latency_seconds': 'pool_stats.write_latency_seconds.main',
            'px_pool_stats_writethroughput': 'pool_stats.write_throughput.main',
            ...
            'px_volume_replication_status': 'volume.replication_status',
            'px_volume_state': 'volume.state',
            'px_volume_attached_state': 'volume.attached_state',
            'px_volume_read_iops': 'volume.read_iops',
            'px_volume_read_bytes': 'volume.read_bytes',
            'px_volume_read_latency_seconds': 'volume.read_latency_seconds',
            'px_volume_write_iops': 'volume.write_iops',
            'px_volume_write_latency_seconds': 'volume.write_latency_seconds',
            'px_volume_num_discard_ops': 'volume.discard_ops',
            'px_volume_discarded_bytes': 'volume.discarded_bytes',

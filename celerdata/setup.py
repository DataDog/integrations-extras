...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'celerdata', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    ...
    keywords='datadog agent celerdata check',
    # The project's main homepage.
    url='https://github.com/DataDog/integrations-extras',
    # Author details
    author='CelerData',
    author_email='support@celerdata.com',
    # License
    ...
    packages=['datadog_checks.celerdata'],

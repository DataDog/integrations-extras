...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'neptune_apex', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-neptune_apex',
    version=ABOUT['__version__'],
    description='The Neptune Apex check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent neptune_apex check',
    ...
    packages=['datadog_checks.neptune_apex'],

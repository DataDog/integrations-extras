...
from .metrics import APPLICATION_METRICS, API_SERVER_METRICS
...
class ArgocdCheck(OpenMetricsBaseCheck):
    ...
    def __init__(self, name, init_config, instances):
        ...
        application_endpoint = instance.get('application_endpoint')
        api_server_endpoint = instance.get('operator_endpoint')

        # # Cannot have both Argocd-agent and Argocd-operator metrics enabled
        ...
        if not application_endpoint and not api_server_endpoint:
        ...
        instance.update(
            {
                ...
                'metadata_metric_name': 'argo_cd_version',

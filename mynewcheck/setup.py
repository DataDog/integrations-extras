...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'mynewcheck', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-mynewcheck',
    version=ABOUT['__version__'],
    description='The MyNewCheck check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent mynewcheck check',
    # The project's main homepage.
    url='https://github.com/DataDog/integrations-extras',
    # Author details
    author='FJ',
    author_email='hi@fannyjiang.com',
    # License
    ...
    packages=['datadog_checks.mynewcheck'],

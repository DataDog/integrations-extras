...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'statuscake', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-statuscake',
    version=ABOUT['__version__'],
    description='The StatusCake check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent statuscake check',
    # The project's main homepage.
    url='https://github.com/DataDog/integrations-extras',
    # Author details
    author='Micael P',
    author_email='sre@commify.com',
    # License
    ...
    packages=['datadog_checks.statuscake'],

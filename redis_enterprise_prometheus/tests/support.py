...
METRICS_MAP = {
    ...
    "REDIS2.DATABASE": [
        ...
        "rdse2.endpoint_client_connection_expired.total",
        "rdse2.endpoint_client_connections.count",
        "rdse2.endpoint_client_connections.total",
        "rdse2.endpoint_client_disconnections.count",
        "rdse2.endpoint_client_disconnections.total",
        "rdse2.endpoint_client_establishment_failures.count",
        "rdse2.endpoint_client_establishment_failures.total",
        "rdse2.endpoint_client_tracking_off_requests.count",
        "rdse2.endpoint_client_tracking_off_requests.total",
        "rdse2.endpoint_client_tracking_on_requests.count",
        "rdse2.endpoint_client_tracking_on_requests.total",
        "rdse2.endpoint_dedicated_sconn_connections.count",
        "rdse2.endpoint_dedicated_sconn_connections.total",
        "rdse2.endpoint_dedicated_sconn_proxy_disconnections.count",
        "rdse2.endpoint_dedicated_sconn_proxy_disconnections.total",
        "rdse2.endpoint_dedicated_sconn_shard_disconnections.count",
        "rdse2.endpoint_dedicated_sconn_shard_disconnections.total",
        "rdse2.endpoint_disposed_commands_after_client_caching.count",
        "rdse2.endpoint_disposed_commands_after_client_caching.total",
        "rdse2.endpoint_egress.count",
        "rdse2.endpoint_egress.total",
        "rdse2.endpoint_egress_pending.count",
        "rdse2.endpoint_egress_pending.total",
        "rdse2.endpoint_egress_pending_discarded.count",
        "rdse2.endpoint_egress_pending_discarded.total",
        "rdse2.endpoint_ingress.count",
        "rdse2.endpoint_ingress.total",
        "rdse2.endpoint_internal_client_connections.count",
        "rdse2.endpoint_internal_client_connections.total",
        "rdse2.endpoint_internal_client_disconnections.count",
        "rdse2.endpoint_internal_client_disconnections.total",
        "rdse2.endpoint_internal_proxy_disconnections.count",
        "rdse2.endpoint_internal_proxy_disconnections.total",
        "rdse2.endpoint_other_requests.count",
        "rdse2.endpoint_other_requests.total",
        ...
        "rdse2.endpoint_other_responses.total",
        "rdse2.endpoint_proxy_disconnections.count",
        "rdse2.endpoint_proxy_disconnections.total",
        "rdse2.endpoint_read_requests.count",
        "rdse2.endpoint_read_requests.total",
        ...
        "rdse2.endpoint_read_responses.total",
        "rdse2.endpoint_sconn_application_handshake_failure.count",
        "rdse2.endpoint_sconn_application_handshake_failure.total",
        "rdse2.endpoint_sconn_establishment_failure.count",
        "rdse2.endpoint_sconn_establishment_failure.total",
        "rdse2.endpoint_shared_sconn_connections.count",
        "rdse2.endpoint_shared_sconn_connections.total",
        "rdse2.endpoint_shared_sconn_proxy_disconnections.count",
        "rdse2.endpoint_shared_sconn_proxy_disconnections.total",
        "rdse2.endpoint_shared_sconn_shard_disconnections.count",
        "rdse2.endpoint_shared_sconn_shard_disconnections.total",
        "rdse2.endpoint_write_requests.count",
        "rdse2.endpoint_write_requests.total",
        ...
        "rdse2.endpoint_write_responses.total",
    ],
    "REDIS2.NODE": [

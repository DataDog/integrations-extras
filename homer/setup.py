...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'homer', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    ...
    description='The homer check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent homer check',

...
def test_check_ok(aggregator, pricing_client, pricing_client_stubber):
    ...
    pricing_client_stubber.deactivate()
...
def test_check_checkexception(aggregator, pricing_client, pricing_client_stubber):
    # Mock client responses
    pricing_client_stubber.stub_describe_services_response(['AmazonEC2'])
    pricing_client_stubber.activate()
...
def test_check_describe_services_clienterror(aggregator, pricing_client, pricing_client_stubber):
    # Mock client responses
...
def test_check_get_products_clienterror(aggregator, pricing_client, pricing_client_stubber):
    # Mock client responses
    pricing_client_stubber.stub_describe_services_response(['AmazonEC2'])

...
def test_config():
    with pytest.raises(CheckException):
        JfrogMetricsCheck(CHECK_NAME, {}, 'artifactory', [{}])

    JfrogMetricsCheck(CHECK_NAME, {}, 'artifactory', [MOCK_ART_INSTANCE])


@pytest.mark.unit
def test_openmetrics_art_check(aggregator, mock_art_agent_data):
    c = JfrogMetricsCheck(CHECK_NAME, {}, 'artifactory', [MOCK_ART_INSTANCE])

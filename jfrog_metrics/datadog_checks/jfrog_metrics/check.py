...
class JfrogMetricsCheck(AgentCheck):
    def __init__(self, name, init_config, instances):
        # super(JfrogMetricsCheck, self).__init__(name, init_config, instances)
    ...
    def check(self, _):
        ...
        #     self.service_check(
        #         "jfrog_metrics.can_connect", AgentCheck.CRITICAL, message=str(e)
        #     )
        #     raise
        ...
        # self.service_check("jfrog_metrics.can_connect", AgentCheck.OK)

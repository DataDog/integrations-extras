...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'aerospike_enterprise', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-aerospike_enterprise',
    version=ABOUT['__version__'],
    description='The Aerospike check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent aerospike_enterprise check',
    # The project's main homepage.
    url='https://github.com/DataDog/integrations-extras',
    # Author details
    author='Aerospike',
    author_email='support@aerospike.com',
    # License
    ...
    packages=['datadog_checks.aerospike_enterprise'],

...
# named `octominimal.yaml` in `/etc/datadog-agent/conf.d`.  Pass in your
...
class OctoMinimalCheck(AgentCheck):
    ...
    def check(self, instance):
        ...
        self.gauge("octominimal.rpi_core_temp", rpi_core_temp)
        # get api data
        ...
        # print(pct_completed)
        self.gauge("octominimal.est_print_time", est_print_time)
        self.gauge("octominimal.pct_completed", pct_completed)
        ...
        self.gauge("octominimal.print_job_time", print_job_time)
        self.gauge("octominimal.print_job_time_left", print_job_time_left)
        ...
        for key in z.keys():
            ...
            self.gauge("octominimal." + bedname + ".current_bed_temp", current_bed_temp)
            self.gauge("octominimal." + bedname + ".target_bed_temp", target_bed_temp)

...
class CloudsmithCheck(AgentCheck):
    ...
    def get_api_json(self, url):
        self.tags.append('FULL_URL:{}'.format(url))
    ...
    def check(self, instance):
        ...
        self.gauge("cloudsmith.token_bandwidth_total", entitlement_info['token_bandwidth_total'], tags=self.tags)
        self.gauge("cloudsmith.token_download_total", entitlement_info['token_download_total'], tags=self.tags)

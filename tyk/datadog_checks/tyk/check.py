...
class TykCheck(AgentCheck):
    def __init__(self, name, init_config, instances):
        # super(TykCheck, self).__init__(name, init_config, instances)
    ...
    def check(self, _):
        ...
        #     self.service_check(
        #         "tyk.can_connect", AgentCheck.CRITICAL, message=str(e)
        #     )
        #     raise
        ...
        # self.service_check("tyk.can_connect", AgentCheck.OK)

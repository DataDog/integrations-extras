...
1. Create a `upsc/` folder in the `conf.d/` folder at the root of your Agent's directory. 
2. Create a `conf.yaml` file in the `upsc/` folder previously created.
...
### Events
The UPSC check does not include any event at this time.

### Service Checks
The UPSC check does not include any service check at this time.

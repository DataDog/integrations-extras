...
- import metrics from Datadog to ilert and provide information about the health of your services on ilert status pages
...
To import metrics from Datadog and display them on your ilert status page, follow the instructions [here][9]

...
def hbase_master_version
  ENV['FLAVOR_VERSION'] || 'latest'
end

def hbase_master_rootdir
  "#{ENV['INTEGRATIONS_DIR']}/hbase_master_#{hbase_master_version}"
end

namespace :ci do
  namespace :hbase_master do |flavor|
    ...
    task cleanup: ['ci:common:cleanup'] do
      sh %(docker-compose -f \
           #{ENV['TRAVIS_BUILD_DIR']}/hbase_master/ci/resources/docker-compose-hbase.yaml down -v)
    end

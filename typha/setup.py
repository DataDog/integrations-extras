...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'typha', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    ...
    description='The Typha check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent typha check',
    # The project's main homepage.
    url='https://github.com/DataDog/integrations-extras',
    # Author details
    author='Carlos Motta',
    author_email='motta.carlos08@gmail.com',
    # License

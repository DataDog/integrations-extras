...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'choreo', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    ...
    description='The Choreo check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent choreo check',
    # The project's main homepage.
    url='https://github.com/DataDog/integrations-extras',
    # Author details
    author='Choreo',
    author_email='choreo-help@wso2.com',
    # License
    ...
    packages=['datadog_checks.choreo'],

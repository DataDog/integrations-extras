...
4. Upload the build artifact to any host with an Agent and run `sudo -u dd-agent -- datadog-agent integration install -w path/to/bind9/dist/<ARTIFACT_NAME>.whl`.

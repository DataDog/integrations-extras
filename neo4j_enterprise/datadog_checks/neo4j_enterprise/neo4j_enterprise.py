...
class Neo4jEnterpriseCheck(PrometheusCheck):
    def check(self, instance):
        ...
        for metric in metrics:
            ...
            if config.neo4j_version in ["4.0", "4.1"]:
    ...
    def _get_config(self, instance):
        ...
        if neo4j_version not in ["3.5", "4.0", "4.1"]:
    ...
    def _set_whitelisted_metrics(self):
        ...
        self.metrics_mapper = Neo4jEnterpriseCheck.get_whitelisted_metrics()

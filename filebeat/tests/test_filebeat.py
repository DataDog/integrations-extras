...
def _build_instance(name, stats_endpoint=None, only_metrics=None, timeout=None):
    instance = {
        'registry_file_path': registry_file_path(name)
    }
...
def generate_http_profiler_body(body_update):
    base_body = {
        ...
        'memstats': {
            'Alloc': 6561080, 'TotalAlloc': 24661290312, 'Sys': 25938232,
            'Lookups': 35143, 'Mallocs': 86545328, 'Frees': 86527266,
            'HeapAlloc': 6561080, 'HeapSys': 17006592, 'HeapIdle': 7553024,
            'HeapInuse': 9453568, 'HeapReleased': 0, 'HeapObjects': 18062,
            'StackInuse': 819200, 'StackSys': 819200, 'MSpanInuse': 129920,
            'MSpanSys': 229376, 'MCacheInuse': 2400, 'MCacheSys': 16384,
            'BuckHashSys': 1556137, 'GCSys': 2643968, 'OtherSys': 3666575,
            'NextGC': 9491669, 'LastGC': 1520619692758256437, 'PauseTotalNs': 14387932504,
...
def mock_request(body_update=None):
    return mock.patch(
        ...
        return_value=mock.MagicMock(
            status_code=200,
            json=lambda: generate_http_profiler_body(body_update)
        )
    )

...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'emily_awesome', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-emily_awesome',
    version=ABOUT['__version__'],
    description='The Awesome check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent emily_awesome check',
    # The project's main homepage.
    url='https://github.com/DataDog/marketplace',
    # Author details
    author='emily',
    author_email='emily@emily.com',
    # License
    ...
    packages=['datadog_checks.emily_awesome'],

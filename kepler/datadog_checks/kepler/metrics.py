...
METRIC_MAP = {
    ...
    'kepler_container_platform_joules': {'name': 'container.platform_joules', 'type': 'counter'},
    ...
    'kepler_container_bpf_cpu_time_ms': {'name': 'container.bpf_cpu_time', 'type': 'counter'},
    'kepler_container_bpf_page_cache_hit': {'name': 'container.bpf_page_cache_hit', 'type': 'counter'},
    'kepler_container_task_clock_ms': {'name': 'container.task_clock', 'type': 'counter'},

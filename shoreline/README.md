...
To configure the Datadog-Shoreline App in Shoreline, you need your Datadog API and application keys and also, to define the Dashboard name and Webhook name.

...
def instance_dm_master_metric_url(_field, _value):
    return 'http://localhost:8261/metrics'


def instance_dm_worker_metric_url(_field, _value):
...
def instance_pump_metric_url(_field, _value):
...
def instance_ticdc_metric_url(_field, _value):
    return 'http://localhost:8301/metrics'


def instance_tidb_metric_url(_field, _value):
    return 'http://localhost:10080/metrics'


def instance_tiflash_metric_url(_field, _value):
    return 'http://localhost:8234/metrics'


def instance_tiflash_proxy_metric_url(_field, _value):
    return 'http://localhost:20292/metrics'


def instance_tikv_metric_url(_field, _value):

...
class InstanceConfig(BaseModel):
    ...
    dm_master_metric_url: Optional[str]
    dm_worker_metric_url: Optional[str]
    ...
    tags: Sequence[str]
    ticdc_metric_url: Optional[str]
    tidb_metric_url: Optional[str]
    tiflash_metric_url: Optional[str]
    tiflash_proxy_metric_url: Optional[str]
    tikv_metric_url: Optional[str]

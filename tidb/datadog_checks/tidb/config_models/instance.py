...
class InstanceConfig(BaseModel):
    ...
    dm_master_metric_url: Optional[str] = None
    dm_worker_metric_url: Optional[str] = None
    ...
    pump_metric_url: Optional[str] = None
    read_timeout: Optional[float] = None
    request_size: Optional[float] = None
    send_distribution_buckets: bool
    ...
    tags: tuple[str, ...]
    ticdc_metric_url: Optional[str] = None
    tidb_metric_url: Optional[str] = None
    tiflash_metric_url: Optional[str] = None
    tiflash_proxy_metric_url: Optional[str] = None
    tikv_metric_url: Optional[str] = None

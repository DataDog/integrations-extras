TIDB_METRICS = {
    'pd_client_request_handle_requests_duration_seconds': 'tidb.pd_client_request_handle_requests_duration.seconds',
    'pd_client_cmd_handle_cmds_duration_seconds': 'tidb.pd_client_cmd_handle_cmds_duration.seconds',
    'tidb_domain_load_schema_duration_seconds]': 'tidb.domain_load_schema_duration.seconds',
    ...
    'tidb_server_handle_query_duration_seconds': 'tidb.server_handle_query_duration.seconds',
    'tidb_session_transaction_duration_seconds': 'tidb.session_transaction_duration.seconds',
    'tidb_tikvclient_txn_cmd_duration_seconds': 'tidb.tikv_client_txn_cmd_duration.seconds',
    'tidb_tikvclient_backoff_seconds': 'tidb.tikv_client_backoff.seconds',
...
PD_METRICS = {
    ...
    'grpc_server_handling_seconds': 'pd.grpc_server_handling.seconds',
...
TIKV_METRICS = {
    ...
    'tikv_coprocessor_request_duration_seconds': 'tikv.coprocessor_request_duration.seconds',
}

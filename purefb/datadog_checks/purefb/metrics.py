METRIC_MAP = [
    {
        ...
        'purefb_array_performance_throughput_iops': {'name': 'array.performance_throughput_iops'},
        ...
        'purefb_array_nfs_latency_usec': {'name': 'array.nfs_latency_usec'},
        'purefb_array_nfs_throughput_iops': {'name': 'array.nfs_throughput_iops'},
        'purefb_array_s3_specific_performance_latency_usec': {'name': 'array.s3_specific_performance_latency_usec'},
        'purefb_array_s3_specific_performance_throughput_iops': {
            'name': 'array.s3_specific_performance_throughput_iops'
        },
        ...
        'purefb_buckets_performance_average_bytes': {'name': 'buckets.performance_average_bytes'},
        ...
        'purefb_buckets_space_objects': {'name': 'buckets.space_objects'},
        'purefb_file_systems_performance_latency_usec': {'name': 'file.systems_performance_latency_usec'},
        'purefb_file_systems_performance_throughput_iops': {'name': 'file.systems_performance_throughput_iops'},
        'purefb_file_systems_performance_bandwidth_bytes': {'name': 'file.systems_performance_bandwidth_bytes'},
        'purefb_file_systems_performance_average_bytes': {'name': 'file.systems_performance_average_bytes'},
        ...
        'purefb_bucket_replica_links_lag_msec': {'name': 'bucket.replica_links_lag_msec'},
        'purefb_file_system_links_lag_msec': {'name': 'file.system_links_lag_msec'},
        ...
        'purefb_array_clients_performance_latency_usec': {'name': 'array.clients_performance_latency_usec'},
        'purefb_array_clients_performance_throughput_iops': {'name': 'array.clients_performance_throughput_iops'},
        'purefb_array_clients_performance_bandwidth_bytes': {'name': 'array.clients_performance_bandwidth_bytes'},

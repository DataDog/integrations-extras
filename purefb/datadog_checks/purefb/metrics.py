METRIC_MAP = [
    {
        ...
        'purefb_array_performance_replication': {'name': 'array.performance_replication'},
        'purefb_array_performance_throughput_iops': {'name': 'array.performance_throughput_iops'},
        'purefb_array_s3_performance_latency_usec': {'name': 'array.s3_performance_latency_usec'},
        'purefb_array_s3_performance_throughput_iops': {'name': 'array.s3_performance_throughput_iops'},
        ...
        'purefb_buckets_object_count': {'name': 'buckets.object_count'},
